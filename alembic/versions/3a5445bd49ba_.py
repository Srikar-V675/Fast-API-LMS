...
Revision ID: 3a5445bd49ba
Revises: 
Create Date: 2024-05-01 17:14:56.523787
...
def upgrade() -> None:
    ...
    sa.Enum('teacher', 'student', name='roles').create(op.get_bind())
    op.add_column(
        'users',
        sa.Column('role', sa.Enum('teacher', 'student', name='roles'), nullable=True),
    )
    ...
    # stack overflow: https://stackoverflow.com/questions/47206201/how-to-use-enum-with-sqlalchemy-and-alembic/76869639?r=Saves_AllUserSaves#76869639
    sa.Enum('lesson', 'quiz', 'assignment', name='contenttypes').create(op.get_bind())
    op.add_column(
        'content_blocks',
        sa.Column('type', sa.Enum('lesson', 'quiz', 'assignment', name='contenttypes'), nullable=True),
    )
